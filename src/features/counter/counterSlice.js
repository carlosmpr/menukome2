...
export const counterSlice = createSlice({
  ...
  reducers: {
    ...
    setMiniSlider:(state, action) => {
      state.miniSliderIndex = action.payload
    },
  },
...
export const { setMiniSlider, setSliderIndex, todaysOffer, setData, menuSelect, detailSelect } = counterSlice.actions;
